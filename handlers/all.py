...
def allGP(client, message,redis):
  ...
  if text :
    ...
    if re.search(c.sors,text):
      kb = InlineKeyboardMarkup([[InlineKeyboardButton("قروب السورس 📢", url="t.me/DleelI")],[InlineKeyboardButton("تواصل السورس 💬", url="t.me/FSFFF")],[InlineKeyboardButton("شروحات السورس 📑", url="t.me/DleelI")]])
